    ...
    <div className="w-full bg-white py-12 space-y-16">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          {/* Card 1: Overview */}
          <div className="bg-white border border-slate-300 p-5 rounded-2xl flex flex-col justify-between shadow-xs">
          ...
          <div className="bg-white border border-slate-300 p-5 rounded-2xl shadow-xs flex flex-col justify-between">
            <div>
      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start pt-4">
        ...
        <div className="lg:col-span-5 bg-blue-50/10 border border-slate-300 rounded-2xl p-6 relative flex flex-col justify-between min-h-[170px]">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-300/60 mt-4">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-4 pt-2">
        ...
        <div className="flex items-center justify-between border border-slate-300 rounded-xl p-5 bg-white/50">
