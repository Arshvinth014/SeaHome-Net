    ...
    <div className="relative w-full bg-gradient-to-b from-blue-50/30 via-white to-white pb-20 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 pt-2 lg:pt-1 grid grid-cols-1 lg:grid-cols-12 gap-1 items-center">
        ...
        <div className="lg:col-span-3 space-y-7 z-20 pointer-events-auto">
          ...
          <div className="grid grid-cols-2 gap-y-4 gap-x-4 pt-6 border-t border-slate-100 text-[11px] font-bold text-slate-400">
        ...
        <div className="lg:col-span-2 w-full flex justify-end lg:justify-center z-10">
          <div className="bg-white border border-slate-100 w-full max-w-[240px] rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] p-4 space-y-3">
            <div className="leading-tight relative">
              ...
              <p className="text-[10.5px] text-slate-400 font-semibold mt-1 leading-normal">
                Your real estate guide. How can I help you today?
              </p>
            </div>
            <div className="space-y-1 text-[11px] text-slate-600 font-bold">
              <button className="w-full bg-slate-50/60 hover:bg-slate-50 p-2.5 rounded-xl text-left flex justify-between items-center group transition-colors cursor-pointer">
                <span className="flex items-center gap-2 text-slate-700 font-extrabold"><Compass className="w-3.5 h-3.5 text-slate-400" /> Find Properties</span>
                <span className="text-slate-300 group-hover:text-blue-600 transition-colors">›</span>
              </button>
              <button className="w-full bg-slate-50/60 hover:bg-slate-50 p-2.5 rounded-xl text-left flex justify-between items-center group transition-colors cursor-pointer">
                <span className="flex items-center gap-2 text-slate-700 font-extrabold"><Briefcase className="w-3.5 h-3.5 text-slate-400" /> Invest Opportunities</span>
                <span className="text-slate-300 group-hover:text-blue-600 transition-colors">›</span>
              </button>
              <button className="w-full bg-slate-50/60 hover:bg-slate-50 p-2.5 rounded-xl text-left flex justify-between items-center group transition-colors cursor-pointer">
                <span className="flex items-center gap-2 text-slate-700 font-extrabold"><Building className="w-3.5 h-3.5 text-slate-400" /> Find Agencies</span>
                <span className="text-slate-300 group-hover:text-blue-600 transition-colors">›</span>
              </button>
              <button className="w-full bg-slate-50/60 hover:bg-slate-50 p-2.5 rounded-xl text-left flex justify-between items-center group transition-colors cursor-pointer">
                <span className="flex items-center gap-2 text-slate-700 font-extrabold"><BarChart3 className="w-3.5 h-3.5 text-slate-400" /> Market Insights</span>
                <span className="text-slate-300 group-hover:text-blue-600 transition-colors">›</span>
              </button>
              <button className="w-full bg-slate-50/60 hover:bg-slate-50 p-2.5 rounded-xl text-left flex justify-between items-center group transition-colors cursor-pointer">
                <span className="flex items-center gap-2 text-slate-700 font-extrabold"><HelpCircle className="w-3.5 h-3.5 text-slate-400" /> Learn More</span>
                <span className="text-slate-300 group-hover:text-blue-600 transition-colors">›</span>
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-slate-100 p-5 space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
            <div className="lg:col-span-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50/60 border border-slate-200/40 rounded-xl p-3 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-blue-500 font-medium transition-colors"
                />
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative">
                <select className="w-full bg-slate-50/60 border border-slate-200/40 rounded-xl p-3 pr-8 text-xs text-slate-600 font-bold focus:outline-none appearance-none cursor-pointer">
