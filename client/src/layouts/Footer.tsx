export function Footer() {
  return (
    <footer className="w-full bg-[#030914] text-slate-400 text-xs border-t border-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 leading-relaxed text-[11px] text-slate-500 font-medium">
            <li className="flex items-center gap-1.5 text-slate-400">✉️ support@seahomenet.com</li>
      ...
      <div className="border-t border-slate-900 max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-center text-slate-600 text-[10.5px] font-medium">
